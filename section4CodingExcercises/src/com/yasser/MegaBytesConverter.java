...
public class MegaBytesConverter {
    public static final int ONE_MEGABYTE_IN_KILOBYTES = 1024;
    public static void printMegaBytesAndKiloBytes(int kiloBytes){
        if(kiloBytes<0){
            System.out.println("Invalid Value");
            return;
        }
        int megaBytes = kiloBytes/ONE_MEGABYTE_IN_KILOBYTES;
        int remainingKilobytes = kiloBytes-megaBytes*ONE_MEGABYTE_IN_KILOBYTES;
