...
public class MobilePhone {
    ...
    public Contact queryContact(String contactName) {
        int queryResult = findContact(contactName);
        return queryResult>-1?myContacts.get(queryResult):null;
    }
    public boolean updateContact(Contact contact,Contact update){
        if(this.myContacts.contains(contact)){
            this.myContacts.set(this.myContacts.indexOf(contact),update);
            return true;
        }
        return false;
    }
    ...
    public void printContacts(){
        ...
        for (Contact contact:this.myContacts
            ...
            System.out.println((this.myContacts.indexOf(contact)+1)+". "+contact.getName()+" -> "+contact.getPhoneNumber());
        }
    }
}
